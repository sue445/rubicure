...
```ruby
>> Precure.now
=> {:series_name=>"hugtto", :title=>"ＨＵＧっと！プリキュア", :started_date=>Sun, 04 Feb 2018, :ended_date=>Sun, 27 Jan 2019, :girls=>["cure_yell", "cure_ange", "cure_etoile", "cure_macherie", "cure_amour"]}
...
=> [["pink", 12], ["blue", 10], ["yellow", 11], ["red", 7], ["purple", 7], ["white", 4], ["green", 3], ["rainbow", 1], ["black", 1]]
```
