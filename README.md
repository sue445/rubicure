...
```ruby
>> Precure.now
=> {series_name: "star_detective", title: "名探偵プリキュア！", started_date: #<Date: 2026-02-01 ((2461073j,0s,0n),+0s,-Infj)>, girls: ["cure_answer", "cure_mystique", "cure_eclair", "cure_arcana"]}
...
=> [["pink", 19], ["blue", 16], ["yellow", 15], ["purple", 14], ["white", 8], ["red", 8], ["green", 6], ["rainbow", 2], ["black", 2], ["orange", 1], ["gold", 1]]
```
