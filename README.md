...
```ruby
>> Precure.now
=> {:series_name=>"delicious_party", :title=>"デリシャスパーティ♡プリキュア", :started_date=>#<Date: 2022-02-06 ((2459617j,0s,0n),+0s,-Infj)>, :girls=>["cure_precious", "cure_spicy", "cure_yumyum", "cure_finale"]}
