...
```ruby
>> Precure.now
=> {series_name: "star_detective", title: "名探偵プリキュア！", started_date: #<Date: 2026-02-01 ((2461073j,0s,0n),+0s,-Infj)>, girls: ["cure_answer", "cure_mystique", "cure_arcana_shadow"]}
...
=> [2, 3, 2, 5, 6, 4, 4, 4, 5, 5, 4, 4, 3, 6, 5, 5, 4, 5, 4, 5, 4, 5, 3]
...
=> [["pink", 19], ["blue", 16], ["yellow", 15], ["purple", 14], ["red", 8], ["white", 7], ["green", 5], ["black", 3], ["rainbow", 2], ["orange", 1], ["gold", 1]]
```
